...
const Banner = () => {
    return (
        <section>
            <div className='pt-[50px] pb-[350px] xl:pt-[195px] xl:pb-[558px]'>
                <Container>
                    <div className=''>
                        <div className='relative text-center '>
                            <h1 className='font-primary xl:text-[56px] text-[30px] text-white xl:leading-[64px] leading-[40px] font-bold max-w-[796px] mx-auto'>Get your work done with Management Tool</h1>
