...
const Banner = () => {
    return (
        <section>
            <div className='pt-[50px] pb-[350px] lg:pt-[195px] lg:pb-[558px]'>
                <Container>
                    <div className=''>
                        <div className='relative text-center '>
                            ...
                            <div className='text-center lg:mt-8 mt-5 relative'>
                                ...
                                <button className='font-secondary text-lg leading-[20px] text-[#2C2643] py-[15px]  px-[20px] lg:px-[28.5px] rounded-[6px] bg-secondery cursor-pointer absolute top-[7px] right-1.5 lg:right-[473px]'>Try for free</button>
                            </div>
                            <div className='w-[400px] sm:w-auto absolute left-[-19%] lg:left-[-3%] bottom-[-300px] sm:bottom-[-410px] lg:bottom-[-815px]'>
