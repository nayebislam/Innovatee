                    ...
                    <div className=''>
                        <div className='relative text-center '>
                            ...
                            <div className='text-center xl:mt-8 mt-5 relative'>
                                ...
                                <button className='font-secondary text-lg leading-[20px] text-[#2C2643] py-[15px]  px-[20px] xl::px-[28.5px] rounded-[6px] bg-secondery cursor-pointer absolute top-[7px] right-1.5 sm:right-26.5 xl:right-[473px]'>Try for free</button>
                            </div>
